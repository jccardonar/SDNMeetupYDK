...
2. Continue with the StaticRoute/staticRoute.ipynb. 
  1. Note that this part includes an optional exercise with ansible.
...
To access the Jupyter hub, simply run in any browser.

To get access to the router:
* Use if you are 
* Use the "" icon in the desktop icon.

For access to the server:
* 
* Use the "" icon in the remote desktop.
